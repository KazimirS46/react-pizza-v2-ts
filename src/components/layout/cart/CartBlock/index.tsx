    ...
    <div className={styles.containerCart}>
      <div className={styles.cart}>
        <div className={styles.cartTop}>
          ...
          <button className={styles.cartClear} onClick={clear}>
            <svg
              width='20'
              height='20'
              viewBox='0 0 20 20'
        ...
        <ul className={styles.contentItems}>
          {products &&
            products.map((product) => <CartItem key={product.changeID} data={product} />)}
        </ul>
        <div className={styles.cartBottom}>
          ...
          <div className={styles.cartBottomButtons}>
            ...
            >
              ...
              <span className={styles.back}>Вернуться&nbsp;</span>
              <span>назад</span>
            </Link>
            <div className={`${styles.button} ${styles.payBtn}`}>
              <span>Оплатить</span>
              <span className={styles.now}>&nbsp;сейчас</span>
            </div>
          </div>
        </div>
      </div>
